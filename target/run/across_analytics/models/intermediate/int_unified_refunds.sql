  ...
  create view "across_analytics"."dbt_intermediate"."int_unified_refunds__dbt_tmp"
...
base_refunds AS (
    ...
    FROM "across_analytics"."dbt_staging"."stg_base__refunds"
),
...
bsc_refunds AS (
    ...
    FROM "across_analytics"."dbt_staging"."stg_bsc__refunds"
),
...
optimism_refunds AS (
    ...
    FROM "across_analytics"."dbt_staging"."stg_optimism__refunds"
),
