  ...
  create view "across_analytics"."staging"."stg_base__fills__dbt_tmp"
    
    
  as (
    -- Staging model for FilledRelay events from Base
...
WITH raw_fills AS (
    ...
    SELECT
        ...
        blockchain,                      -- Which blockchain (should be 'base')
...
cleaned_fills AS (
    SELECT
        ...
        -- Output token: The token address on the destination chain (Base in this case)
        -- Already decoded by ETL to proper address format
